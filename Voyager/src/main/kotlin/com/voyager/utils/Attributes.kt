...
object Attributes {
    ...
    object Common {
        ...
        const val BACKGROUND_TINT_MODE = "backgroundTintMode"
        ...
        const val DRAWING_CACHE_QUALITY = "drawingCacheQuality"
        ...
        const val FOREGROUND_TINT_MODE = "foregroundTintMode"
        const val GRAVITY = "gravity"
        const val HEIGHT = "height"
        const val HINT = "hint"
        const val ID = "id"
        const val IME_OPTIONS = "imeOptions"
        const val IMPORTANT_FOR_ACCESSIBILITY = "importantForAccessibility"
        ...
        const val MAX_HEIGHT_SYSTEM = "maxHeight"
        const val MAX_WIDTH = "maxWidth"
        const val MAX_WIDTH_SYSTEM = "maxWidth"
        const val MIN_HEIGHT = "minHeight"
        const val MIN_HEIGHT_SYSTEM = "minHeight"
        const val MIN_WIDTH_SYSTEM = "minWidth"
        ...
        const val SCREEN_READER_FOCUSABLE = "screenReaderFocusable"
    ...
    object View {
        ...
        const val VIEW_ALIGN_BASELINE = "layout_alignBaseline"
        ...
        const val VIEW_ALIGN_PARENT_BOTTOM = "layout_alignParentBottom"
        const val VIEW_ALIGN_PARENT_END = "layout_alignParentEnd"
        const val VIEW_ALIGN_PARENT_LEFT = "layout_alignParentLeft"
        const val VIEW_ALIGN_PARENT_RIGHT = "layout_alignParentRight"
        const val VIEW_ALIGN_PARENT_START = "layout_alignParentStart"
        const val VIEW_ALIGN_PARENT_TOP = "layout_alignParentTop"
        ...
        const val VIEW_ANIMATE_LAYOUT_CHANGES = "animateLayoutChanges"
        const val VIEW_ANIMATION = "animation"
        const val VIEW_BASELINE_ALIGN_BOTTOM = "baselineAlignBottom"
        const val VIEW_BELOW = "layout_below"
        const val VIEW_CENTER_HORIZONTAL = "layout_centerHorizontal"
        const val VIEW_CENTER_IN_PARENT = "layout_centerInParent"
        const val VIEW_CENTER_VERTICAL = "layout_centerVertical"
        ...
        const val VIEW_FILTER_TOUCHES_WHEN_OBSCURED = "filterTouchesWhenObscured"
        const val VIEW_FITS_SYSTEM_WINDOWS = "fitsSystemWindows"
        const val VIEW_FOCUSABLE = "focusable"
        const val VIEW_FOCUSABLE_IN_TOUCH_MODE = "focusableInTouchMode"
        const val VIEW_FORCE_HAS_OVERLAPPING_RENDERING = "forceHasOverlappingRendering"
        const val VIEW_HAPTIC_FEEDBACK_ENABLED = "hapticFeedbackEnabled"
        const val VIEW_IS_SCROLL_CONTAINER = "isScrollContainer"
        ...
        const val VIEW_REQUIRES_FADING_EDGE = "requiresFadingEdge"
        ...
        const val VIEW_SCROLLBAR_FADE_DURATION = "scrollbarFadeDuration"
        const val VIEW_SCROLLBAR_SIZE = "scrollbarSize"
        const val VIEW_SCROLLBAR_STYLE = "scrollbarStyle"
        const val VIEW_SELECTED = "selected"
        const val VIEW_SOUND_EFFECTS_ENABLED = "soundEffectsEnabled"
        const val VIEW_STATE_LIST_ANIMATOR = "stateListAnimator"
    ...
    object RatingBar {
        ...
        const val RATINGBAR_PROGRESS_DRAWABLE = "progressDrawable"
    ...
    object TextView {
        ...
        const val TEXTVIEW_FIRST_BASELINE_TO_TOP_HEIGHT = "firstBaselineToTopHeight"
        const val TEXTVIEW_FONT_VARIATION_SETTINGS = "fontVariationSettings"
        const val TEXTVIEW_HTML = "html"
        const val TEXTVIEW_HYPHENATION_FREQUENCY = "hyphenationFrequency"
        const val TEXTVIEW_INPUT_TYPE = "inputType"
        const val TEXTVIEW_LAST_BASELINE_TO_BOTTOM_HEIGHT = "lastBaselineToBottomHeight"
        ...
        const val TEXTVIEW_PRIVATE_IME_OPTIONS = "privateImeOptions"
        const val TEXTVIEW_SELECT_ALL_ON_FOCUS = "selectAllOnFocus"
        ...
        const val TEXTVIEW_TEXT_COLOR_HIGHLIGHT = "textColorHighlight"
        const val TEXTVIEW_TEXT_COLOR_LINK = "textColorLink"
        const val TEXTVIEW_TEXT_SCALE_X = "textScaleX"
        const val TEXTVIEW_TRANSFORMATION_METHOD = "transformationMethod"
    }
    ...
    object EditText {
        ...
        const val EDITTEXT_TRANSFORMATION_METHOD = "transformationMethod"
    }
    ...
    object ViewGroup {
        ...
        const val VIEW_GROUP_ALWAYS_DRAWN_HORIZONTAL_FADING_EDGE = "alwaysDrawnHorizontalFadingEdge"
        const val VIEW_GROUP_ALWAYS_DRAWN_VERTICAL_FADING_EDGE = "alwaysDrawnVerticalFadingEdge"
        const val VIEW_GROUP_ANIMATE_LAYOUT_CHANGES = "animateLayoutChanges"
        const val VIEW_GROUP_ANIMATION_CACHE_ENABLED = "animationCacheEnabled"
    ...
    object ProgressBar {
        const val PROGRESSBAR_INCREMENTAL_SECONDARY_PROGRESS = "incrementSecondaryProgress"
    ...
    object ListView {
        ...
        const val LISTVIEW_OVER_SCROLL_MODE = "overScrollMode"
    ...
    object ConstraintLayout {
        ...
        const val CONSTRAINTLAYOUT_LAYOUT_CONSTRAINT_HEIGHT_RATIO = "layout_constraintHeight_ratio"
        ...
        const val CONSTRAINTLAYOUT_LAYOUT_CONSTRAINT_WIDTH_RATIO = "layout_constraintWidth_ratio"
    ...
    object TabLayout {
        const val TAB_INDICATOR_GRAVITY = "indicatorGravity"
    ...
    object MediaController {
        ...
        const val MEDIA_TITTLE = "showTittle"
    }
    ...
    object MaterialNavigationBarView {
        ...
        const val NAVIGATION_BAR_VIEW_SELECTED_ITEM_ID = "selectedItemId"
    }

    object MaterialBottomNavigationView {
        const val BOTTOM_NAVIGATION_VIEW_ACTIVE_INDICATOR_ENABLED =
            "itemActiveIndicatorEnabled"
        const val BOTTOM_NAVIGATION_VIEW_ACTIVE_INDICATOR_HEIGHT = "itemActiveIndicatorHeight"
        const val BOTTOM_NAVIGATION_VIEW_ACTIVE_INDICATOR_INSET = "itemActiveIndicatorInset"
        const val BOTTOM_NAVIGATION_VIEW_ACTIVE_INDICATOR_SHAPE_APPEARANCE =
            "itemActiveIndicatorShapeAppearance"
        const val BOTTOM_NAVIGATION_VIEW_ACTIVE_INDICATOR_WIDTH = "itemActiveIndicatorWidth"
        ...
        const val SHAPE_APPEARANCE_CORNER_FAMILY = "itemShapeAppearanceCornerFamily"
    }

    object ExtendedFloatingActionButton {
        const val EXTENDED_FLOATING_ACTION_BUTTON_EXTENDED = "extended"
    ...
    object Chip {
        ...
        const val CHIP_CHIP_TEXT_COLOR = "chipTextColor"
    ...
    object ScrollBar {
        const val SCROLL_DEFAULT = "scrollIndicators" // Kept for clarity, already in common
        const val SMOOTH_SCROLL = "smoothScrollbar"  // Kept for clarity, already in common
