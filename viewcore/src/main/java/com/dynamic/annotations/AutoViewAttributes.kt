package com.dynamic.annotations

/**
 * Specifies that a class should automatically generate view attributes based on its properties.
 *
 * This annotation is used in conjunction with a code generator (e.g., an annotation processor)
 ...
 * )
 * ```
 * In this example, the annotation processor would generate code that allows the "text", "textColor", and "textSize" attributes
 ...
 * - Proper configuration of the annotation processor is crucial for this functionality to work correctly.
