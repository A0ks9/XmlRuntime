...
class ObjectValue : Value() {
    ...
    override fun copy(): ObjectValue = ObjectValue().apply {
        members.forEach { (key, value) -> put(key, value.copy()) }
    }

    fun put(property: String, value: Value) {
     ...
     */
    fun isPrimitive(memberName: String): Boolean = contains(memberName) && this[memberName] is Primitive
     ...
     */
    fun isObject(memberName: String): Boolean = contains(memberName) && this[memberName] is ObjectValue
    /**
