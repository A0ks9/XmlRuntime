 ...
 *
 * This object replaces the separate `ViewAttributes`, `WebViewAttributes`, etc., objects,
 * providing a single, organized place for all attribute constants. It uses nested objects
 * (View, WebView, RatingBar, etc.) to group related attributes, mirroring the original Java structure.
 *
...
object Attributes {
     ...
     */
    object View { // Kotlin object for View attributes
     ...
     */
    object WebView { // Kotlin object for WebView attributes
     ...
     */
    object RatingBar { // Kotlin object for RatingBar attributes
     ...
     */
    object TextView { // Kotlin object for TextView attributes
     ...
     */
    object CheckBox { // Kotlin object for CheckBox attributes
     ...
     */
    object FrameLayout { // Kotlin object for FrameLayout attributes
     ...
     */
    object ViewGroup { // Kotlin object for ViewGroup attributes
        const val Children =
     ...
     */
    object LinearLayout { // Kotlin object for LinearLayout attributes
     ...
     */
    object ScrollView { // Kotlin object for ScrollView attributes
     ...
     */
    object HorizontalScrollView { // Kotlin object for HorizontalScrollView attributes
     ...
     */
    object ProgressBar { // Kotlin object for ProgressBar attributes
